...
Begin VB.Form form_recepcion 
   ...
   Begin PicClip.PictureClip PClipsubebaja 
      ...
      _ExtentY        =   953
      _Version        =   393216
      Picture         =   "form_recepcionVISTA2.frx":0000
   End
   ...
   Begin PicClip.PictureClip PClip_dir 
      ...
      Rows            =   4
      Cols            =   10
      Picture         =   "form_recepcionVISTA2.frx":0722
   End
   ...
   Begin VB.ComboBox Combo_Velocidad 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "form_recepcionVISTA2.frx":4E0464
      Left            =   6480
      List            =   "form_recepcionVISTA2.frx":4E048E
      TabIndex        =   5
   ...
   Begin VB.ComboBox Combo_Puerto 
      ...
      ForeColor       =   &H00400000&
      Height          =   315
      ItemData        =   "form_recepcionVISTA2.frx":4E04DA
      Left            =   2160
      List            =   "form_recepcionVISTA2.frx":4E04F0
      TabIndex        =   4
      Text            =   "Combo_Puerto"
      Top             =   600
      Width           =   1215
...
On Error GoTo maneja_errores
    ...
    Print #numarchivo, "fecha hora Temperatura Humedad Presión Dirección Velocidad Altura Memoria Bateria" + Chr(13) & Chr(10)
